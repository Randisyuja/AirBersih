...
from users.views import Dashboard, DaftarKasir, TambahKasir, UpdateKasir, DeleteKasir, get_layanan_by_rumah, UserLoginView, UserLogoutView, SignUpView
...
urlpatterns = [
    ...
    path("users/<int:pk>/hapus/", DeleteKasir.as_view(), name="delete_users"),
