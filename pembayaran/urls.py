...
urlpatterns = [
    ...
    path("pembayaran/export/pdf/<str:layanan>/<int:tahun>", export_pembayaran_pdf, name="export_pembayaran_pdf"),
    path("laporan/<str:layanan>/", laporan_tahunan, name="laporan_tahunan"),
]
